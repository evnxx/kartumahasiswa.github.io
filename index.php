...
<html>
  ...
  <body class="hold-transition login-page" style="background-image: url('img/bg2.png');">
    <?php
            ...
            <div class='row'>
                <div class='col-12'>
                   <div class='alert alert-danger alert-dismissible'>
                        ...
                        <center><h4><i class='fa fa-warning '></i> PERINGATAN!</h4><i>Sorry, Silahkan masukkan kembali username dan password..!</i></center>
                    </div>
                </div>
            </div>
          </div>
    ...
    <div class="login-box" style="margin-top: 40px;">
      ...
      <div  class="login-box-body" style="border-top: 10px solid #FF4500;border-top-left-radius: 20px; box-shadow: 0px 3px 6px 0px #FF4500;">
      ...
      <p class="text-center" style="background-color: #FF4500; color: #FFFFFF; border-bottom-right-radius: 20px; box-shadow: 0px 1px 6px 0px #3c8dbc;">
        <?php echo "$r[title]";?> - <?php echo "$r[sekolah]";?><br> Versi 2.0 <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?><br>
        <marquee>Powered by <a target="_blank" href="#"><b style="color: #ffffff;">Lauma IT</b></marquee></a>
      </p>
    </div>
